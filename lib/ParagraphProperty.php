 ...
 * 
 * ParagraphProperty is used by Paragraph to define the properties of the paragraph instance.
 *  
...
class ParagraphProperty {
	...
	/**
	 * Processes the specified paragraph property node
	 * 
	...
	/**
	 * Process the attributes for the paragraph property node
	 *	 
	...
	/**
	 * Get the start number for a bullet based on the specified node
	 *  
    ...
    /** 
     * Get the class definition for the bullet type
     * 
