...
class Shape {
     ...
     * 
     * @param object $node the node that represents a shape
     * 
     ...
     * 
     * @param object $node the node that represents a non visual shape
     * 
	 ...
	 * 		 
     * @param object $node the node that represents a non visual drawing property
     * 
     ...
     * 
     * @param object $node the node that represents a shape property
     * 
